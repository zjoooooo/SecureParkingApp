...
public class Style {
	...
	public static class Builder {
		...
		public Builder() {
			...
			widthInPixels = LayoutParams.WRAP_CONTENT;
		...
		/**
		 * The resource id for the file path and name of the font for the
		 * crouton view's content.
		 */
	...
	public String toString() {
		return "Style{" + "configuration=" + configuration
				...
				+ ", fontName=" + fontName + ", fontNameResId=" + fontNameResId
				+ '}';
	}
}
