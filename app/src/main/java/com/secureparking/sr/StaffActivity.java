...
public class StaffActivity extends Activity {
			...
			case SUCCESS:
				...
				lv_bo.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						String bo = li.get(position).get("Staff");
				...
				SimpleAdapter mSchedule = new SimpleAdapter(StaffActivity.this,
						li,
						R.layout.boitem,
						new String[] { "Staff" },
	...
	private void init() {
		new Thread() {
			...
			public void run() {
				...
				try {
					String jsonstr = NetUtils.GetStaffList();
	...
	public ArrayList<HashMap<String, String>> Analysis(String jsonStr)
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			map.put("Staff", jsonObject.getString("Staff"));
